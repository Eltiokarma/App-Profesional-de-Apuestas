...
El backend no escribe nada: el pipeline de extracción sigue siendo el único
dueño de sad.db → levels.db → constants.db → discreto.db.
Las rutas se resuelven en SAD_DATA_DIR (por defecto, la raíz de este repo:
pega ahí tus 4 bases, están ignoradas por git).
"""
import os
import sqlite3
