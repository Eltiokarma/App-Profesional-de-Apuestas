...
def dtp_demo(foco: str, rival: str, torneo: str | None, fecha: str | None) -> dict:
    """DTP de muestra para el modo demo (0 requests, 0 tokens): permite
    desarrollar la pantalla sin clave. Deliberadamente reconocible como demo."""
    return {
        "cadena": {"tiene_anterior": True, "partido_anterior": f"{foco} vs rival anterior (demo)"},
        "cierre": {
            "m4_goles": [{
                ...
                "responsables_error": [{"jugador": "Volante central", "nivel": "principal",
                                        "detalle": "Pierde la marca en la basculación (demo)"}],
            ...
            "m5": {
                ...
                "contraste_pronostico": {"aciertos": ["El carril izquierdo era la vía (demo)"],
                                          "fallos": ["Se esperaba mayor control en el primer tramo"]},
            },
            "registro": {"pronostico_clave": "Duelo por izquierda decisivo (demo)",
                         "que_paso": "Por ahí llegó el gol", "veredicto": "parcial",
                         "leccion": "La cobertura del carril débil manda sobre la posesión"},
        },
        "apertura": {
            "m1": {"sistema": "4-2-3-1 (demo)", "cambios_vs_anterior": ["Vuelve el lateral titular"],
            ...
            "m2": {"choque_sistemas": f"4-2-3-1 de {foco} contra el 3-5-2 de {rival} (demo)",
                   "duelos_carril": [
            ...
            "m3_fases": [
                {"tramo": "0-25", "plan": "Bloque medio y salida limpia",
                 "palancas": ["Cambiar de banda al tercer pase"]},
                {"tramo": "25-65", "plan": "Fijar por dentro para abrir el carril",
                 "palancas": ["Interior entre líneas"]},
                {"tramo": "65-80+", "plan": "Sostener con frescura por fuera",
                 "palancas": ["Extremo de refresco al carril débil"]},
            ],
            "m6": {"competitivo": True, "rotacion": "Sin rotación relevante (demo)",
                   "fatiga": "6 días de descanso", "ausencias_clave": "Ninguna",
                   "otros": f"{torneo or 'torneo'} · {fecha or 'fecha'}"},
        },
        "datos_faltantes": ["ejemplo de modo demo"],
        "fuentes": [],
    }
