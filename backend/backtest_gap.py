...
def backtest(muestra: int = 300, liga: int | None = None, temporada: int | None = None,
             desde: str | None = None, hasta: str | None = None, semilla: int = 42) -> dict:
    ...
    for f in fixtures:
        ...
        for team_id, rival_id, es_local, gf, ga in (
            ...
            clasica[_bucket(g["senal"], g["tendencia"])].append(par)
            ajustada[_bucket(g["senalAjustada"], g["tendenciaAjustada"])].append(par)
...
def main():
    ...
    r = backtest(a.muestra, a.liga, a.temporada, a.desde, a.hasta, a.semilla)
