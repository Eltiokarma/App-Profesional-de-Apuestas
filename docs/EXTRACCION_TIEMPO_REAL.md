...
- **Backoff por liga** (`SAD_LIVE_BACKOFF_PASO_MIN`/`_TOPE`, 3 min × rondas,
  tope 10 → 30 min). Auditoría de la noche del 31/07/2026: **796 requests
  ...
  fixture tampoco insiste en una liga dormida: si la API no cubre la liga,
  tampoco cubre su partido — eso era el 100 % de esos 290.
